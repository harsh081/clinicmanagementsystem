					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
                                                 ...
                                                 <li><a class="menu active" href="DoctotrSide_FeedBack.php" > View FeedBack </a></li>
		...
		<div class="container">
			<div class="row main">
				<div class="main-login main-center">
                                ...
                                $query1 = $data->query("select a.Full_Name,b.Feedback_date,b.Feedback from patient_master a,Feedback_Master b where a.Patient_id=b.Patient_id;");
                                if ($query1 == TRUE) {
