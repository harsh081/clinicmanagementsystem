					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu" href="#about">about us</a></li>
                                                <li><a class="menu" href="LoginMain.php">Login </a></li>
			    ...
			    <div id="carouselHacked" class="carousel slide carousel-fade" data-ride="carousel" >
			        ...
			        <div class="carousel-inner" role="listbox">
			            <div class="item active">
			            	<img width="2000" width="800"src="img/slide-one.jpg" alt="">
			                
			            </div>
			            <div class="item">
                                        <img width="2000" width="800" src="img/slide-two.jpg" alt="">
			                
			            </div>
			            <div class="item">
			            	<img width="2000" width="800" src="img/slide-three.jpg" alt="">
				...
				<div class="col-md-4 col-sm-6">
					<div class="single-about-detail">
						...
						<div class="about-details">
							...
							<h3>Daily Health Care Advice</h3>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<div class="single-service">
						...
						<h3>Detail Health Care Advice</h3>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="single-service">
