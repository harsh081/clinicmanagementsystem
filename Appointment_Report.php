        ...
        <div class="container">
            <div class="row main">
                <div class="main-login main-center">
                    <h2 style="text-align: center" > Total  appointment of patient REPORT</h2>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 no-padding">
                            ...
                            if (isset($_POST['BtnSubmit'])) {
                                ...
                                $query = $mysqli->query(" select a.Full_Name,COUNT(b.Patient_id) as b from patient_master a,Appointment_Master b where a.Patient_id=b.Patient_id  and b.Appointment_Date between '$from' and '$to'   group by b.Patient_id");
                                if ($query == true) {
                                    while ($row = $query->fetch_assoc()) {
