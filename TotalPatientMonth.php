        ...
        <div class="container">
            <div class="row main">
                <div class="main-login main-center">
                    <h2 style="text-align: center" > MONTH WISE PATIENT REPORT</h2>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 no-padding">
                            ...
                            if (isset($_POST['BtnSubmit'])) {
                                ...
                                $query = $mysqli->query("select b.Full_Name as a,count(a.Patient_id)as b from appointment_master a, patient_master b where a.Patient_id=b.Patient_id  and a.Appointment_Date  between '$from' and '$to' group by a.Patient_id");
                                if ($query == true) {
                                    while ($row = $query->fetch_assoc()) {
