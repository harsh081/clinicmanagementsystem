        ...
        <div class="container">
            <div class="row main">
                <div class="main-login main-center">
                    <h2 style="text-align: center" > HIGHEST MEDICINES SALES  REPORT</h2>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 no-padding">
                            ...
                            if (isset($_POST['BtnSubmit'])) {
                                ...
                                $query = $mysqli->query("select count(Medicine_id) as a from prescription_master where Date_of_Prescription between '$from' and '$to'");
                                if ($query == true) {
                                    while ($row = $query->fetch_assoc()) {
                                        $counts = $row['a'];
                                    }
                                }
                                $query = $mysqli->query("select a.Medicine_name as a,count(b.Medicine_id) as b from medicine_stock_master a,prescription_master b where a.Medicine_id=b.Medicine_id and b.Date_of_Prescription between '$from' and '$to' group by a.Medicine_id ");
                                if ($query == true) {
                                    while ($row = $query->fetch_assoc()) {
